...
//output the results to user
            this.keyTable(table);
            //textView3.setText(this.keyTable(table));
...
//prints the key-table in matrix form
                    ...
                    textView3.setText(printTable[i][j]+" ");
                    Toast.makeText(Playfair.this, "printTable[i][j]", Toast.LENGTH_SHORT).show();
                }
                System.out.println();
            }
            System.out.println();
...
//prints the encrypted message
            textView1.setText("Encrypted Message:- " +encipher);
            System.out.println();
            System.out.print("Decrypted Message: ");
//prints the decryted message
            textView2.setText("Decrypted Message:- " +dec);
        }
    }
